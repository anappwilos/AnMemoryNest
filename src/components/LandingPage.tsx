  ...
  return (
    <div className="min-h-screen bg-stone-50 font-sans text-stone-900">
      ...
      <header className="px-8 py-6 flex items-center justify-between">
        ...
        <button className="bg-amber-900 text-white px-5 py-2 rounded-full text-sm font-medium hover:bg-amber-800">New Memory</button>
      </header>
      ...
      <main className="px-8 py-16 max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <h2 className="text-6xl font-serif text-amber-950 mt-4 mb-6">No guardes solo fotos. <span className="italic text-amber-800">Preserva las historias</span> detrás de ellas.</h2>
          ...
          <div className="flex gap-4">
            <button onClick={onStart} className="bg-amber-900 text-white px-8 py-3 rounded-full font-medium hover:bg-amber-800 flex items-center gap-2">
              Crear mi cápsula familiar <ArrowRight className="w-4 h-4" />
            </button>
            <button className="border border-stone-300 text-stone-800 px-8 py-3 rounded-full font-medium hover:bg-stone-100">Ver demo</button>
          </div>
        </div>
