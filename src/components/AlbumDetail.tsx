...
import { Camera, Share2, MapPin, Calendar, Heart, Users } from 'lucide-react';
    ...
    <div className="min-h-screen bg-stone-50 font-sans text-stone-900">
        ...
        <div className="border-b border-stone-200 bg-white">
            <div className="max-w-7xl mx-auto px-8 flex gap-8">
                {['Historia', 'Recuerdos', 'Personas', 'Conversación'].map((tab, i) => (
                    <button key={tab} className={`py-4 text-sm font-bold uppercase tracking-widest ${i === 0 ? 'text-amber-900 border-b-2 border-amber-900' : 'text-stone-500'}`}>
                        {tab}
                    </button>
                ))}
            </div>
